...
package com.baogutang.frame.uuid.impl;

import com.baogutang.frame.uuid.BitsAllocator;
import com.baogutang.frame.uuid.UidGenerator;
import com.baogutang.frame.uuid.buffer.BufferPaddingExecutor;
import com.baogutang.frame.uuid.buffer.RejectedPutBufferHandler;
import com.baogutang.frame.uuid.buffer.RejectedTakeBufferHandler;
import com.baogutang.frame.uuid.buffer.RingBuffer;
 ...
 * from {@link com.baogutang.frame.uuid.impl.DefaultUidGenerator}, based on a lock free {@link RingBuffer}<p>
 * 
...
public class CachedUidGenerator extends com.baogutang.frame.uuid.impl.DefaultUidGenerator implements DisposableBean {
